...
public interface SysRoleMapper {
    ...
    public Long     selectCount(SysRole sysRole);
    public List<SysRole> selectPage(SysRole sysRole);
    public List<SysRole> select(SysRole sysRole);
    public SysRole       selectOne(SysRole sysRole);
    public List<SysRole> selectAll();
    public SysRole       selectByPk(Integer id);


    /** 主键或唯一索引冲突时，报错 */
    public int insert(SysRole sysRole);
    /** 主键或唯一索引冲突时，不报错，就丢弃此记录，但mysql有warning日志 */
    public int insertOrIgnore(SysRole sysRole);
    /** 主键或唯一索引冲突时，执行更新操作 */
    ...
    */
    ...
    public int insertMulti(List<SysRole> list);
    /** 1个insert多个values，主键或唯一索引冲突时，不报错，丢弃冲突的记录，其它记录正常入库，但mysql有warning日志 */
    public int insertMultiOrIgnore(List<SysRole> list);
    ...
    public int insertMultiOrUpdateWithNull(List<SysRole> list);
    /** 1个insert多个values，主键或唯一索引冲突时，执行更新操作，如果字段值为空，最终会被设置为null，更新时，丢弃excludeProperties里的字段 */
    public int insertMultiOrUpdateWithNullExcludeUpdateProperty(List<SysRole> list, Collection<String> excludeProperties);
    ...
    */
    ...
    public int multiInsert(List<SysRole> list);
    public int multiInsertOrIgnore(List<SysRole> list);
    public int multiInsertOrUpdate(List<SysRole> list);
    public int multiInsertOrUpdateWithNull(List<SysRole> list);


    /** 注意，pk必须设置值，否则报错，其它字段值为null，则丢弃此字段的更新 */
    public int update(SysRole sysRole);
    /** 注意，pk必须设置值，否则报错，其它字段值为null，则mysql实际也会将该字段设置为null */
    public int updateWithNull(SysRole sysRole);
    /** 注意，pk必须设置值，否则报错，set column=column+? where id=? */
    public int updateWithInc(SysRole sysRole);
    /** 注意，pk必须设置值，否则报错，乐观锁，表必须有version字段, 否则报错 */
    public int updateWithVersion(SysRole sysRole);

    /** 注意，自定义更新条件，字段值为null，则丢弃此字段的更新 */
    public int updateWhere(SysRole sysRole);
    /** 注意，自定义更新条件，字段值为null，则mysql实际也会将该字段设置为null */
    public int updateWhereWithNull(SysRole sysRole);
