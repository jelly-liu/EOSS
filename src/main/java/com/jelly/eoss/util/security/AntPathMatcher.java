...
public class AntPathMatcher implements PatternMatcher {
    ...
    protected boolean matchStart(String pattern, String path) {
     ...
     */
    protected String extractPathWithinPattern(String pattern, String path) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(antPathMatcher.match("/system/*Add.jsp", "/system/userAdd.jsp"));
    }
}
