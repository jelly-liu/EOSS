...
<html>
	<head>
		<%@ include file="/system/include/head.jsp"%>
  		<script src="${BASE_PATH}/js/system/userUpdate.js" type="text/javascript"></script>
  		<style type="text/css">
  			#zTreeNodeJson{
  				display:none;
  			}
	...
	<body>
		<form id="submitForm" action="${BASE_PATH}/user/updateUser.ac" class="eossForm" method="post">
