...
<script src="${BASE_PATH}/js/layout/main.js" type="text/javascript"></script>
...
<body class="easyui-layout">
	...
	<div data-options="region:'center'">
		<div id="centerWindowDiv">
			<iframe id="centerFrame" name="centerFrame" src="${BASE_PATH}/system/layout/center.jsp" frameborder="0" width="100%" height="100%" marginwidth="0" marginheight="0"></iframe>
		</div>
	</div>
