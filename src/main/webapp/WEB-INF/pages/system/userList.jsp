...
<html>
	<head>
		<%@ include file="/WEB-INF/pages/include/head.jsp"%>
  		<script src="${BASE_PATH}/static/js/system/userList.js?time=<%=System.currentTimeMillis()%>" type="text/javascript"></script>
	</head>

	<body>
		<form id="submitForm" action="${BASE_PATH}/system/user/toList" class="eossForm" method="post">
			...
			<table class="eossFromTable">
				...
				<tr>
					<td align="left">
						用户ID：<input type="text" name="id" value="${id}"/>&nbsp;&nbsp;&nbsp;&nbsp;
